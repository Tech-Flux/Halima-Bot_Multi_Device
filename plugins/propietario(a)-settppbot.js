...
let handler = async (_0x55976e, {
    ...
    try {
        ...
        if (!_0x55976e[_0x2359c0(0x1bb)]) throw '*Reply to image which you want, be Halima Dp using this Command ' + (_0x33d1e6 + _0x480711) + '*';
...
handler['command'] = /^setdp$/i, handler[_0x34771d(0x1c0)] = !![];
export default handler;

function _0x14c2() {
    const _0x1897e4 = ['AUTO', 'user', '8CJixwu', 'getHeight', 'getBufferAsync', 'w:profile:picture', '*Profile Picture for Bot changed Succesfully✅*', 'picture', 'read', '1419731ZjYevm', 'MIME_JPEG', '82272azbcaw', '350agtQLJ', '279gQMikZ', 'mimetype', '188728rlRvtO', 'msg', 'jid', 'image', '1705364hxGRFM', '14905ZvBfug', '2578255zmHnCy', 'getWidth', 'reply', '1780230pdlTpE', 'download', 'quoted', 'query', '2810ZHRQDi', 'resize', '*Send the image first then reply to it🙂', 'rowner'];
    _0x14c2 = function () {
        return _0x1897e4;
    };
    return _0x14c2();
